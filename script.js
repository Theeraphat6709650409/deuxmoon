...
async function buyProduct(platform, duration_days, basePrice, displayName, hasWarrantyOption) {
    ...
    try {
        ...
        if (result.status === 'success') {
            ...
            // --- เรียกใช้ กฎการใช้งานอัตโนมัติ (HTML Mode) ---
            receiptHtml += getAppRules(platform, true);
...
// ==========================================
// ฟังก์ชันดึงกฎการใช้งานอัตโนมัติตามแอปพลิเคชัน
// ==========================================
function getAppRules(platform, isHtml = false) {
    let rulesText = "";
    let rulesHtml = "";
    ...
    if (platform.includes('youtube')) {
        ...
        rulesHtml = `<strong style="color: #ff8080; font-size: 14px;">🌟 YouTube Premium 🌟</strong><br><div style="text-align: center; margin-bottom: 8px; color: #ffd6d6;">📌 กฎการใช้งาน</div>- ห้ามเปลี่ยนแปลง แก้ไขรหัสหรือข้อมูลใดๆทั้งสิ้น ปรับ 1000฿<br>- เมลร้านไม่อนุญาตให้เอาไปเชื่อมต่อแอพอื่นนอกจาก youtube นะคะ<br>- พบเจอขออนุญาตยึดคืนโดยไม่จำเป็นต้องแจ้งให้ทราบ ขอบคุณค่ะ`;
    } 
    else if (platform.includes('iqiyi')) {
        rulesText = "🌸 iQIYI 🌸\n\n📌 กฎการใช้งาน\n⚠️ ห้ามกดอัพแพคเกจจะทำให้วันลด ทางร้านไม่รับเคลมค่า\n✨ ล็อกอิน 1 เครื่องเท่านั้น\n✨ จอหารจะมีประวัติการดูทับกันเป็นปกติน้า\n✨ เข้าไม่ได้ รหัสผิดให้แจ้งทางร้านทันที\n✨ ห้ามเปลี่ยนแปลงหรือเผยแพร่รหัสให้ผู้อื่น พบเจอปรับ 1000฿";
        
        rulesHtml = `<strong style="color: #ff8080; font-size: 14px;">🌸 iQIYI 🌸</strong><br><div style="text-align: center; margin-bottom: 8px; color: #ffd6d6;">📌 กฎการใช้งาน</div>⚠️ ลบช่องอีเมลก่อนกดเข้าระบบนะคะ<br>⚠️ ห้ามกดอัพแพคเกจจะทำให้วันลด ทางร้านไม่รับเคลมค่า<br>✨ ล็อกอิน 1 เครื่องเท่านั้น<br>✨ จอหารจะมีประวัติการดูทับกันเป็นปกติน้า<br>✨ เข้าไม่ได้ รหัสผิดให้แจ้งทางร้านทันที<br>✨ ห้ามเปลี่ยนแปลงหรือเผยแพร่รหัสให้ผู้อื่น พบเจอปรับ 1000฿`;
    } 
    else if (platform.includes('wetv')) {
        rulesText = "🌸 WeTV 🌸\n\n📌 กฎการใช้งาน\n✨ ล็อกอิน 1 เครื่องเท่านั้น\n✨ จอหารจะมีประวัติการดูทับกันเป็นปกติน้า\n✨ เข้าไม่ได้ รหัสผิดให้แจ้งทางร้านทันที\n✨ ไม่เคลมกรณีระบบระงับการใช้งาน ต้องรอระบบปลดเท่านั้นน้า ไม่มีการชดเชยวันให้ค่ะ\n✨ ห้ามเปลี่ยนแปลงหรือเผยแพร่รหัสให้ผู้อื่น พบเจอปรับ 1000฿";
        
        rulesHtml = `<strong style="color: #ff8080; font-size: 14px;">🌸 WeTV 🌸</strong><br><div style="text-align: center; margin-bottom: 8px; color: #ffd6d6;">📌 กฎการใช้งาน</div>✨ ล็อกอิน 1 เครื่องเท่านั้น<br>✨ จอหารจะมีประวัติการดูทับกันเป็นปกติน้า<br>✨ เข้าไม่ได้ รหัสผิดให้แจ้งทางร้านทันที<br>✨ ไม่เคลมกรณีระบบระงับการใช้งาน ต้องรอระบบปลดเท่านั้นน้า ไม่มีการชดเชยวันให้ค่ะ<br>✨ ห้ามเปลี่ยนแปลงหรือเผยแพร่รหัสให้ผู้อื่น พบเจอปรับ 1000฿`;
    } 
        ...
        rulesHtml = `<strong style="color: #ff8080; font-size: 14px;">🌸 กฎการใช้งาน 🌸</strong><br><div style="text-align: center; margin-bottom: 8px; color: #ffd6d6;">📌 (TrueID / Viu / Bilibili / OneD)</div>✨ ล็อกอิน 1 เครื่องเท่านั้น<br>✨ อาจมีประวัติการดูทับกันเป็นปกติน้า<br>✨ เข้าไม่ได้ รหัสผิดให้แจ้งทางร้านทันที<br>✨ ห้ามเปลี่ยนแปลงหรือเผยแพร่รหัสให้ผู้อื่น พบเจอปรับ 1000฿`;
    } 
    else if (platform.includes('ch3')) {
        rulesText = "🌸 Ch3 Plus 🌸\n\n📌 กฎการใช้งาน\n⚠️ ห้ามกดระงับตอนอีกท่าน \"กำลังดูอยู่\" หากทางร้านทราบจะระงับทั้งคู่ทันที\n✨ รับชมพร้อมกัน 1 เครื่อง แบบหาร2 (จอชนรบกวนรอเท่านั้นน้า)\n✨ จอหารจะมีประวัติการดูทับกันเป็นปกติค่ะ\n✨ เข้าไม่ได้แจ้งทางร้านทันที\n✨ ห้ามเปลี่ยนแปลงหรือเผยแพร่รหัสให้ผู้อื่น พบเจอปรับ 1000฿";
        
        rulesHtml = `<strong style="color: #ff8080; font-size: 14px;">🌸 Ch3 Plus 🌸</strong><br><div style="text-align: center; margin-bottom: 8px; color: #ffd6d6;">📌 กฎการใช้งาน</div>⚠️ ห้ามกดระงับตอนอีกท่าน "กำลังดูอยู่" หากทางร้านทราบจะระงับทั้งคู่ทันที<br>✨ รับชมพร้อมกัน 1 เครื่อง แบบหาร2 (จอชนรบกวนรอเท่านั้นน้า)<br>✨ จอหารจะมีประวัติการดูทับกันเป็นปกติค่ะ<br>✨ เข้าไม่ได้แจ้งทางร้านทันที<br>✨ ห้ามเปลี่ยนแปลงหรือเผยแพร่รหัสให้ผู้อื่น พบเจอปรับ 1000฿`;
    } 
        ...
        rulesText = "🌸 กฎการใช้งาน 🌸\n\n📌 (Disney / HBO / Monomax / ChatGPT / Prime)\n1. ✨ ถ้าเข้าไม่ได้ให้รีบแจ้งร้านทันทีน้า\n2. ✨ เข้าใช้งานได้ 1 เครื่องเท่านั้น\n3. ✨ ห้ามเปลี่ยนแปลงหรือเผยแพร่รหัสให้ผู้อื่น พบเจอปรับ 1000฿";
        
        rulesHtml = `<strong style="color: #ff8080; font-size: 14px;">🌸 กฎการใช้งาน 🌸</strong><br><div style="text-align: center; margin-bottom: 8px; color: #ffd6d6;">📌 (Disney / HBO / Monomax / ChatGPT / Prime)</div>1. ✨ ถ้าเข้าไม่ได้ให้รีบแจ้งร้านทันทีน้า<br>2. ✨ เข้าใช้งานได้ 1 เครื่องเท่านั้น<br>3. ✨ ห้ามเปลี่ยนแปลงหรือเผยแพร่รหัสให้ผู้อื่น พบเจอปรับ 1000฿`;
    } 
    else {
        rulesText = "🌟 กฎการใช้งานร่วมกัน 🌟\n\n📌 ลูกค้าที่น่ารักทำตามกฎกันด้วยนะคะ\n⚠️ ผิดกฎปรับ 500.-\n\n✨ ทำการ Log in เข้าสู่ระบบหลังจากได้รับรหัสทันที\n✨ ไม่มั่ว/ ไม่เอาไปหาร / ไม่เปลี่ยนรหัสบัญชีโดยเด็ดขาด\n✨ ไม่เข้าหรือแก้ไขโปรไฟล์คนอื่น\n✨ 1 จอ = รับชมทีละ 1 อุปกรณ์\n✨ ถ้าไม่ได้ซื้อแบบทีวี ห้ามรับชมบนทีวี\n✨ หากพบเจอว่ามีการนำไปแชร์รหัสกับผู้อื่น ขออนุญาตทำการยึดจอ ไม่คืนเงิน\n\n⭐ ทางร้านขายจอส่วนตัวเท่านั้น ห้ามนำไปหารหรือแชร์ต่อโดยเด็ดขาด";
        
        rulesHtml = `<strong style="color: #ff8080; font-size: 14px;">🌟 กฎการใช้งานร่วมกัน 🌟</strong><br><div style="text-align: center; margin-bottom: 8px; color: #ffd6d6;">📌 ลูกค้าที่น่ารักทำตามกฎกันด้วยนะคะ (ผิดกฎปรับ 500.-)</div>✨ ทำการ Log in เข้าสู่ระบบหลังจากได้รับรหัสทันที<br>✨ ไม่มั่ว/ ไม่เอาไปหาร / ไม่เปลี่ยนรหัสบัญชีโดยเด็ดขาด<br>✨ ไม่เข้าหรือแก้ไขโปรไฟล์คนอื่น<br>✨ 1 จอ = รับชมทีละ 1 อุปกรณ์<br>✨ ถ้าไม่ได้ซื้อแบบทีวี ห้ามรับชมบนทีวี<br>✨ หากพบเจอว่ามีการนำไปแชร์รหัสกับผู้อื่น ขออนุญาตทำการยึดจอ ไม่คืนเงิน<br><br><span style="color: #ffb74d; font-weight: bold;">⭐ ทางร้านขายจอส่วนตัวเท่านั้น ห้ามนำไปหารหรือแชร์ต่อโดยเด็ดขาด</span>`;
    }

    if (isHtml) {
        return `<div style="margin-top: 15px; padding: 15px; background: rgba(255, 99, 71, 0.1); border-left: 4px solid #ff4d4d; border-radius: 4px; font-size: 13px; line-height: 1.6; text-align: left; color: #ffd6d6;">${rulesHtml}</div>`;
    }
    return rulesText;
}